...
namespace lab8
{
    ...
    public class Button
    {
        ...
        class Program
        {
            ...
            {
                string readPath = @"C:\PWL\study\OOP\lab8\input.txt";
                string writePath = @"C:\PWL\study\OOP\lab8\output.txt";
                List<double> nums1 = new List<double> { 23.5, 65.4, 32.1, 9.0012 };
                List<int> nums2 = new List<int> { 1000, 64, 128, 256 };
                IVector<double> vector1 = new Vector<double>(nums1);
                IVector<int> vector2 = new Vector<int>(nums2);
                IVector<Button> vector3 = new Vector<Button>("accept");
                ...
                Vector<int> vector6 = new Vector<int>(nums3);
                vector6.Print();
            }
        }
    }